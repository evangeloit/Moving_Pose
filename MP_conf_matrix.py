...
dataset_s1 = ['mhad_s01_a02', 'mhad_s01_a03','mhad_s01_a04',\
          'mhad_s01_a05', 'mhad_s01_a06',\
          'mhad_s01_a09',\
            'mhad_s06_a02', 'mhad_s06_a03','mhad_s06_a04', 'mhad_s06_a05',\
          'mhad_s06_a06','mhad_s06_a09']
...
for name in dataset_s1:
    ...
    last_frame = 190#dataLim['limits'][1]
...
for subject1 in range(0, len(dataset_s1)/2):
    for subject6 in range(0, len(dataset_s1)/2):
        ...
        print(len(Y))
        score[subject1][subject6] = C[-1, -1]/len(Y)
